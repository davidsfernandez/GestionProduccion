...
public class ProductManagementTests : TestContext
{
    ...
    [Fact]
    public void ProductManagement_ShouldHandleDecimalInput_WithPtBRCulture()
    {
        // Set culture
        ...
        var cut = RenderComponent<ProductManagement>();
