...
$ResourceGroup = "gestionproduccion-rg"
$Location = "brazilsouth"
$RandomSuffix = Get-Random -Minimum 1000 -Maximum 9999
$AcrName = "gestionproduccionacr$RandomSuffix"
$EnvName = "gestionproduccion-env"
$DbAppName = "gestionproduccion-db"
$WebAppName = "gestionproduccion-app"
...
Write-Host "[*] Iniciando Despliegue desde Cero en Azure..." -ForegroundColor Cyan
...
az acr create --resource-group $ResourceGroup --name $AcrName --sku Basic --admin-enabled true > $null
...
az containerapp env create --name $EnvName --resource-group $ResourceGroup --location $Location > $null
...
az containerapp create `
  ...
  --min-replicas 1 `
  --max-replicas 1 `
  --bind-mounts gp-db-mount=/var/lib/mysql > $null
