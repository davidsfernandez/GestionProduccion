...
namespace GestionProduccion.Migrations
{
    ...
    [Migration("20260208023024_SyncUserRolesToOperator")]
    partial class SyncUserRolesToOperator
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GestionProduccion.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            Name = "Administrator",
                            PasswordHash = "$2a$11$3XiOHG0ehRq11HY6ynx13O.UHHtg.YP0ngEb04oyblENZnMhQr4Re",
                            Role = "Administrator"
                        });
                });
