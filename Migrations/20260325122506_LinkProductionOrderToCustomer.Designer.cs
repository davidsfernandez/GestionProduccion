...
namespace GestionProduccion.Migrations
{
    ...
    [Migration("20260325122506_LinkProductionOrderToCustomer")]
    partial class LinkProductionOrderToCustomer
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GestionProduccion.Domain.Entities.CRM.CustomerProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GestionProduccion.Domain.Entities.CRM.Quote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GestionProduccion.Domain.Entities.CRM.QuoteItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal?>("EstimatedFabricCost")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal?>("ProfitMarginApplied")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("GestionProduccion.Domain.Entities.CRM.CustomerProfile", b =>
                {
                    b.HasOne("GestionProduccion.Domain.Entities.User", "User")
                        .WithOne()
                        .HasForeignKey("GestionProduccion.Domain.Entities.CRM.CustomerProfile", "UserId")
            ...
            modelBuilder.Entity("GestionProduccion.Domain.Entities.CRM.QuoteItem", b =>
                {
                    ...
                    b.HasOne("GestionProduccion.Domain.Entities.CRM.Quote", "Quote")
                        .WithMany("Items")
