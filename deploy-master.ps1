...
$ConnectionString = "Server=gp-db;Port=3306;Database=$DbName;User Id=$DbUser;Password=$DbPass;AllowUserVariables=true;ConvertZeroDateTime=true;Connect Timeout=60;"
