...
namespace GestionProduccion.Resources
{
    public static class Portuguese
    {
        ...
        public const string OP_NoOrdersFound = "Nenhuma ordem de producción encontrada.";
        ...
        public const string OP_ProductDesc = "Descrição do Producto";
        ...
        public const string OP_WorkflowDesc = "As ordens devem seguir o flujo: Corte -> Costura -> Revisão -> Embalagem.";
        ...
        public const string OP_FinalizeEffects = "Esta ação irá encerrar o cronómetro, calcular custos e actualizar estoque.";
        public const string OP_LoadingSelectors = "Carregando seletores dinámicos...";
        ...
        public const string OP_ProductReference = "Referência do Producto";
        public const string OP_ProductSearch = "Buscar Produto...";
        public const string OP_AssignTeamOptional = "Atribuir a una equipe específica";
        ...
        public const string OP_TimerActive = "CRONÓMETRO ATIVO";
        ...
        public const string OP_ReasonNote = "Observación/Motivo:";
        ...
        public const string OP_FinalizeStopTimer = "Encerrar o cronómetro de produção.";
        ...
        public const string User_SuccessUpdate = "Usuário actualizado com sucesso!";
        public const string User_ConfirmDeactivateTitle = "Desativar Usuário";
        public const string User_TeamSelection = "Vincular a una Equipe (Opcional)";
        ...
        public const string Prod_SuccessCreate = "Producto cadastrado com sucesso!";
        public const string Prod_SuccessUpdate = "Producto actualizado com sucesso!";
        public const string Prod_ConfirmDeleteTitle = "Excluir Producto";

        public const string Cat_Title = "Catálogo";
        public const string Cat_NewProduct = "Novo Produto";
        public const string Cat_EditProduct = "Editar Producto";
        ...
        public const string Cat_NoProducts = "Nenhum producto cadastrado no catálogo.";
        public const string Cat_InternalCode = "Código Interno";
        public const string Cat_MainSku = "Referência (SKU)";
        public const string Cat_SaveProduct = "Salvar Producto";
        ...
        public const string Cat_SuccessCreated = "Producto criado!";
        public const string Cat_SuccessUpdated = "Producto actualizado!";
        ...
        public const string Cat_SuccessDeleted = "Producto excluído!";
        public const string Cat_ErrDeleteActiveOrders = "Não é possível excluir productos com ordens ativas.";
        ...
        public const string Prod_ErrNameRequired = "O nome do producto é obrigatório";
        ...
        public const string Prod_ErrInternalCodeLength = "O código não puede exceder 50 caracteres";
        public const string Prod_ErrFabricRequired = "O tipo de tecido é obrigatório";
        public const string Prod_ErrFabricLength = "O tipo de tecido não puede exceder 50 caracteres";
        ...
        public const string Team_ReassignmentBlock = "Esta equipe possui ordens ativas e não puede ser desativada agora.";
        ...
        public const string Team_SuccessMembersUpdated = "Membros actualizados!";
        ...
        public const string Set_FinancialParams = "Parámetros Financeiros";
        ...
        public const string Set_TvAnnouncementPlaceholder = "Ex: Reunião geral ás 15h...";
        ...
        public const string Task_ErrCreate = "Erro al criar tarefa.";
        ...
        public const string Msg_OrderUpdated = "Ordem actualizada com sucesso!";
        public const string Msg_UserUpdated = "Usuário actualizado!";
        ...
        // --- CRM & SALES ---
        public const string CRM_Title = "CRM & Vendas";
        public const string CRM_Pipeline = "Funil de Vendas";
        public const string CRM_Leads = "Prospectos (Leads)";
        public const string CRM_NewLead = "Novo Lead";
        public const string CRM_Qualified = "Qualificado";
        public const string CRM_DesignPending = "Design Pendente";
        public const string CRM_QuoteSent = "Orçamento Enviado";
        public const string CRM_Negotiation = "Negociação";
        public const string CRM_Won = "Ganho (Aprovado)";
        public const string CRM_Lost = "Perdido";
        public const string CRM_Quote = "Orçamento";
        public const string CRM_NewQuote = "Novo Orçamento";
        public const string CRM_GeneratePdf = "Gerar PDF";
        public const string CRM_SuccessLead = "Solicitação recebida com sucesso!";
        public const string CRM_ConfirmEmailSubject = "Recebemos sua solicitação - Serona Gestão";
    }
}