...
namespace GestionProduccion.Resources
{
    ...
    {
        // Geral
        public const string AppName = "Serona Gestão";
        ...
        public const string OP_OrderCreatedSuccess = "Ordem de Produção criada con sucesso!";
        ...
        public const string Prod_ErrNameRequired = "O nome do produto es obrigatório";
        ...
        public const string Prod_ErrSkuLength = "O SKU no pode exceder 50 caracteres";
